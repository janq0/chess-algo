...
gcc $FILES -Wall -std=c99 -D_DEFAULT_SOURCE -O3 -I./src -I./raylib-w/src -I./raylib-w/src/external -L./src -L./raylib-w/src -L./raylib-w/src -lraylib -lopengl32 -lgdi32 -lwinmm -DPLATFROM_DESKTOP
